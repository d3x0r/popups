...
var SimpleNotice = /*#__PURE__*/function (_Popup) {
  ...
  function SimpleNotice(title, question, ok, cancel) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "textOutput", document.createElement("SPAN"));
...
export var GraphicFrame = /*#__PURE__*/function (_Popup2) {
...
export var AlertForm = /*#__PURE__*/function (_Popup3) {
...
var SashPicker = /*#__PURE__*/function (_Popup4) {
  ...
  function SashPicker(opts) {
    ...
    import((opts === null || opts === void 0 ? void 0 : opts.sashScript) || "pickSashForm.js").then(function (sashModule) {
...
var _dataGrid = /*#__PURE__*/new WeakMap();
...
function DataGridRow(grid, threshold, newRow) {
  ...
  _defineProperty(this, "rowData", null);

  _defineProperty(this, "el", null);

  _defineProperty(this, "addUpdates", null);

  _defineProperty(this, "cells", []);

  _classPrivateFieldInitSpec(this, _dataGrid, {
    writable: true,
    value: null
  });

  _defineProperty(this, "newInput", {// update
  });

  _classPrivateFieldSet(this, _dataGrid, grid);
...
var _initialValues = /*#__PURE__*/new WeakMap();

var _suffix = /*#__PURE__*/new WeakMap();
...
var _subFields = /*#__PURE__*/new WeakMap();

var _newRowCallback = /*#__PURE__*/new WeakMap();
...
var DataGrid = /*#__PURE__*/function () {
  ...
  */
  function DataGrid(form, o, field, opts) {
    ...
    _classPrivateFieldInitSpec(this, _initialValues, {
      writable: true,
      value: undefined
    });

    _classPrivateFieldInitSpec(this, _suffix, {
      writable: true,
      value: ''
    });
    ...
    _classPrivateFieldInitSpec(this, _subFields, {
      writable: true,
      value: null
    });

    _classPrivateFieldInitSpec(this, _newRowCallback, {
      writable: true,
    ...
    _classPrivateFieldSet(this, _opts, opts || {});

    _classPrivateFieldSet(this, _subFields, (opts === null || opts === void 0 ? void 0 : opts.columns) || []);

    _classPrivateFieldSet(this, _obj, o);
    ...
    _classPrivateFieldSet(this, _initialValue, o[field].map(function (o) {
      return o;
    })); // keep the original valuess... with a shallow deep copy  (deep shallow?)


    _classPrivateFieldSet(this, _initialValues, o[field].map(function (o) {
      var obj = {};

      _classPrivateFieldGet(_this9, _subFields).forEach(function (col) {
    ...
    _classPrivateFieldSet(this, _suffix, (opts === null || opts === void 0 ? void 0 : opts.suffix) || (form instanceof Popup ? form.suffix : ''));

    if (opts !== null && opts !== void 0 && opts.onNewRow) _classPrivateFieldSet(this, _newRowCallback, opts.onNewRow);

    var thresholdRows = function thresholdRows() {
      return _classPrivateFieldGet(_this9, _obj)[_classPrivateFieldGet(_this9, _field)];
    };
    ...
    _classPrivateFieldSet(this, _table, document.createElement("table"));

    _classPrivateFieldGet(this, _table).className = "data-grid-table" + _classPrivateFieldGet(this, _suffix);

    _classPrivateFieldSet(this, _header, _classPrivateFieldGet(this, _table).insertRow());

    _classPrivateFieldGet(this, _header).className = "data-grid-header-row" + _classPrivateFieldGet(this, _suffix);
    form.appendChild(_classPrivateFieldGet(this, _table));

    _classPrivateFieldGet(this, _subFields).forEach(function (col) {
  ...
  _createClass(DataGrid, [{
    ...
    value: function reset() {
      ...
      var data = _classPrivateFieldGet(this, _obj)[_classPrivateFieldGet(this, _field)];

      data.length = 0;

      var _iterator4 = _createForOfIteratorHelper(_classPrivateFieldGet(this, _initialValue)),
          _step4;
      ...
      var _loop = function _loop(v) {
        ...
        var v = _classPrivateFieldGet(_this10, _initialValues)[v];
      ...
      for (var v = 0; v < _classPrivateFieldGet(this, _initialValues).length; v++) {
        _loop(v);
      } // any old data has a chance to be wrong.


      while (_classPrivateFieldGet(this, _rows).length) {
        var row = _classPrivateFieldGet(this, _rows)[0];

        _classPrivateFieldGet(this, _rows).splice(0, 1);
    ...
    value: function fill() {
      ...
      _classPrivateFieldGet(this, _initialValue).forEach(function (row) {
        _this11.addRow(row);
    ...
    value: function addColumn(name, subField, className, type) {
      var cell = _classPrivateFieldGet(this, _header).insertCell();
    ...
    value: function addRow(newRow) {
...

      {
        var onEdit = function onEdit(cell, newCell, rowData, row) {
          ...
          function newInput(evt) {
            if (!row.rowData) {
              ...
              row.rowData = rowData = _classPrivateFieldGet(this_, _newRowCallback).call(this_, _classPrivateFieldGet(this_, _initialValue));
              addUpdates(rowData);
          ...
          return function (t) {
            _classPrivateFieldGet(_this13, _subFields).forEach(function (key, id) {
              //const c = this.#cells[id].cell;
              var upd = _classPrivateFieldGet(_this13, _cells)[id].upd; // update current value.
          ...
          function addUpdates(rowData) {
            ...
            _classPrivateFieldGet(this_, _cells).forEach(function (cell, idx) {
        ...
        var newTableRow = _classPrivateFieldGet(this, _table).insertRow();

        newTableRow.className = "data-grid-row" + _classPrivateFieldGet(this, _suffix);
        var row = new DataGridRow(this, newRow, newTableRow);

        _classPrivateFieldGet(this, _rows).push(row);

        var this_ = this;

        _classPrivateFieldGet(this, _cells).forEach(function (cell) {
          var newCell = {
            cell: cell,
          ...
          newCell.el.className = cell.className + _classPrivateFieldGet(_this12, _suffix);
...
var PageFramePage = /*#__PURE__*/function () {
  function PageFramePage(frame) {
    ...
    _defineProperty(this, "content", document.createElement('div'));

    _defineProperty(this, "handle", document.createElement('div'));

    _defineProperty(this, "pages", null);

    _classPrivateFieldInitSpec(this, _frame2, {
      writable: true,
      value: null
    });
    ...
    if (frame instanceof PagedFrame) {
      _classPrivateFieldSet(this, _frame2, frame);
      ...
      this.handle.addEventListener("click", function (evt) {
        _classPrivateFieldGet(_this14, _frame2).activate(_this14);
      });
      this.content.style.display = "none";
      frame.pages.push(this);
    } else {
      _classPrivateFieldSet(this, _page, frame);
  ...
  _createClass(PageFramePage, [{
    ...
    key: "frame",
    get: function get() {
      if (_classPrivateFieldGet(this, _frame2)) return _classPrivateFieldGet(this, _frame2);
      return _classPrivateFieldGet(this, _page).frame;
    }
  }, {
    key: "textContent",
    ...
    value: function addPage(title, url) {
      if (!this.pages) {
        if (_classPrivateFieldGet(this, _frame2)) this.pages = new PageFramePages(this, _classPrivateFieldGet(this, _frame2).suffix);else this.pages = new PageFramePages(this, this.frame.suffix);
        this.pages.handleContainer.style.display = "none";
      }
...
var PageFramePages = /*#__PURE__*/function (_Array) {
  ...
  function PageFramePages(frame, suffix) {
    ...
    _defineProperty(_assertThisInitialized(_this15), "handleContainer", document.createElement('div'));

    _defineProperty(_assertThisInitialized(_this15), "pageContainer", document.createElement('div'));

    _classPrivateFieldInitSpec(_assertThisInitialized(_this15), _frame3, {
      writable: true,
      value: null
    });

    _classPrivateFieldInitSpec(_assertThisInitialized(_this15), _page2, {
      writable: true,
      value: null
    });

    if (frame instanceof PagedFrame) {
      _classPrivateFieldSet(_assertThisInitialized(_this15), _frame3, frame);
      ...
      _classPrivateFieldSet(_assertThisInitialized(_this15), _page2, frame);
...
var _oldPage = /*#__PURE__*/new WeakMap();
...
var PagedFrame = /*#__PURE__*/function () {
  function PagedFrame(parent, opts) {
    ...
    _defineProperty(this, "frame", document.createElement('div'));

    _defineProperty(this, "pages", null);

    _classPrivateFieldInitSpec(this, _oldPage, {
      writable: true,
      value: null
    });
  ...
  _createClass(PagedFrame, [{
    ...
    value: function activate(page) {
      if (_classPrivateFieldGet(this, _oldPage)) {
        _classPrivateFieldGet(this, _oldPage).deactivate();
      }

      _classPrivateFieldSet(this, _oldPage, page.activate());
    }
  }]);
